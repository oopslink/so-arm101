...
with (a.out/'runs.csv').open('w') as f:
 keys=['run','commands','positions','duration_s','effective_hz','max_interval_ms','max_joint_change_deg','errors'];w=csv.DictWriter(f,fieldnames=keys,extrasaction='ignore');w.writeheader();w.writerows(runs)
